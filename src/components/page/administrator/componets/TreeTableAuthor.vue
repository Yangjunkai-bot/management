    ...
    <el-table :data="formatData"
      ...
      <el-table-column v-else
        ...
        <template slot-scope="scope">
          ...
          <el-checkbox-group v-if="Array.isArray(scope.row[column.value])"
            ...
            <el-checkbox v-for="(interset) in scope.row[column.value]"
                         :label="interset.id"
                         :key="interset.id">{{interset.description}}</el-checkbox>
          </el-checkbox-group>
          ...
          <el-checkbox v-if="scope.row[column.act]"
                       :indeterminate="scope.row.isIndeterminate"
                       v-model="scope.row.checkAll"
                       @change="handleCheckAllChange1(scope.$index, scope.row,column.option)">{{scope.row[column.act]}}</el-checkbox>
        </template>
      </el-table-column>
      <slot></slot>
    </el-table>
